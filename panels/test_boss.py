...
from ticket_help.panels.boss_multiselect import BossMultiSelect
from ticket_help.panels.simple_ticket_modal import SimpleTicketModal
from ticket_help.panels.spam_select import SpamSelect
