import discord
from panels.server_select import ServerSelect
from panels.type_select import TypeSelect
from panels.ticket_modal import CreateTicketModal
from panels.boss_multiselect_view import BossMultiSelectView
...
class TicketCreateView(discord.ui.View):
    ...
    async def next_step(self, interaction: discord.Interaction, _):
        ...
        await interaction.response.edit_message(
            content="Select all bosses for this ticket:",
            view=view
        )
