...
class Forge(commands.Cog):
    ...
    * <:axeaqw:1487000523268947988> Wrath of the Werepyre (🧟‍♂️Wolfwing,📍 `/join wolfwing`)
    ...
    async def absolution(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:cloakaqw:1457810628168253522> **Absolution**
        > +50% Healing Boost
        > -20% Physical Boost
        - 📝 Must be Level 90.
    ...
    async def vainglory(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:cloakaqw:1457810628168253522> **Vainglory**
        > +15% Damage Boost
        > -50% Healing Intake
        - 📝 Must have completed the previous quest.
        - 📝 Must be Level 90.
    ...
    async def avarice(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:cloakaqw:1457810628168253522> **Avarice**
        > +10% Haste
        > -35% Damage Resistance
        - 📝 Must have completed the previous quest.
        - 📝 Must be Level 90.
        - 📝 Must have Rank 9 Blacksmithing.
        - 🦴 Indulgence `x50` (<:queststart:776313178928971787> 'Circles of Fate' , 📍`/join sevencircles`)
    ...
    async def penitence(self, interaction: discord.Interaction):
        await interaction.response.send_message("""### <:cloakaqw:1457810628168253522> Penitence
        > +25% Damage Resistance
        > -25% DoT Boost
        📝 Must have completed the previous quest.
        📝 Must be Level 90.
        📝 Must have Rank 9 Blacksmithing.
        * <:spearaqw:1487000575290642553> Night Mare Scythe (<:queststart:776313178928971787> 'Yulgar's Worst Nightmare', 📍`/join yulgar`)
    ...
    async def lament(self, interaction: discord.Interaction):
        await interaction.response.send_message("""**Lament**
        > +20% Critical Chance
        > -5% Haste
        📝 Must have completed the previous quest.
        📝 Must be Level 90.
        ...
        * ☀️ Heart of the Sun  (<:queststart:776313178928971787> Warlic's 'Mother Knows The Sun', 📍`/join thirdspell`)
    ...
    async def sword(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:swordaqw:1487004634307629056>**Forge**
    ...
    async def lacerate(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:swordaqw:1487004634307629056>**Lacerate**
        ...
        > -10% Hit Chance
        > -10% Haste
        - 📝 Finished 'Hit Job' <:queststart:776313178928971787> at `/join greenguardwest`
        ...
        - <:axeaqw:1487000523268947988> Massive Horc Cleaver ( <:queststart:776313178928971787> 'Massive Horc Cleaver', 📍`/join warhorc`)
        - <:swordaqw:1487004634307629056> Sword in the Stone ( <:queststart:776313178928971787> 'Landing Swords!', 📍`/join greenguardeast`)
        - 🦴 Black Knight Orb ( <:queststart:776313178928971787> 'Hardly Suiting Armor', 📍`/join greenguardwest`)
        - <:axeaqw:1487000523268947988> Forest Axe ( <:queststart:776313178928971787> 'warm MILK!', 📍`/join greenguardwest`)""")

    @forge.command(
        name="smite", description="Look up Smite Forge Enhancement for Weapon"
    )
    async def smite(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:swordaqw:1487004634307629056>**Smite**
        > 100% chance to activate on the fifth skill (15 second cooldown⌛️).
        > Deals 500% Hybrid Damage.
        - 📝 Finished 'Star Light, Star Bright' <:queststart:776313178928971787> at `/join lumafortress`
    ...
    async def praxis(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:swordaqw:1487004634307629056> **Praxis**
        ...
        - 📝 Finished 'Defeat Jaaku!' <:queststart:776313178928971787> at `/join shadowfortress`
        ...
        - 🦴 Yami `x3` ( <:queststart:776313178928971787>﻿ 'Embracing Darkness', 📍`/join darkally`)""")
    ...
    async def acheron(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:swordaqw:1457810578994233434>**Acheron**
        ...
        > +30% Damage Boost
        > +30% Hit Chance
        - 📝 Finished 'Avatar of Fire' <:queststart:776313178928971787> (Tyndarius) at `/join fireavatar`
        - 📝 Blacksmith Rep rank 8
        - 📝 Level 80
        - 📝 Dark Box & Dark Key for Void Lodestone
        - 🦴 Dark Potion `x20` ( <:queststart:776313178928971787> 'The Dark Box', 📍`/join battleon`)
    ...
    async def valiance(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:swordaqw:1487004634307629056> **Valiance**
        ...
        > x1.3 Endurance
        > x1.15 Luck
        - 📝 Finished 'The Final Challenge' <:queststart:776313178928971787> (Lord of Order <:classbadge:1471256107057156117>) at `/join battleoff`
        - 📝 Blacksmith Rep rank 10
        - 📝 Level 100
        - 📝 <:armoraqw:1487000736087670936> Fire Champion's Armor (💰 Merge, 📍`/join wartraining`)
        - 📝 <:classbadge:1471256107057156117> Dragon of Time ( <:queststart:776313178928971787> 'Hero's Heartbeat', 📍`/join timeinn`)
        - 📝 <:armoraqw:1487000736087670936> Drakath the Eternal ( <:queststart:776313178928971787> 'Eternal Drakath Set', 📍`/join eternalchaos`)
        - 📝 <:swordaqw:1487004634307629056> Eternity Blade ( <:queststart:776313178928971787> 'Find the Eternity Blade', 📍`/join towerofdoom`)
        - 🦴 Gravelyn's DoomFire Token ( <:queststart:776313178928971787> 'The Summoning ', 📍`/join darkthronehub`)
    ...
    async def elysium(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:swordaqw:1487004634307629056>**Elysium**
        > 100% chance to activate on third skill (no cooldown⌛️).
        ...
        > +10% Damage Boost
        - 📝 Finished 'Awe-scention' <:queststart:776313178928971787> at`/join museum`
        - 📝 Blacksmith Rep rank 10
        - 📝 Level 100
        - 🦴 Bones from the Void Realm `x20` (💰 50 Void Aura & 50 Bone Dust, 📍`/join shadowfall`)
        - 🦴 Blademaster Sword Scroll ( <:queststart:776313178928971787> 'Legion Sword Training', 📍`/join darkally`)
        - 🦴 Archfiend Essence Fragment `x3` ( <:queststart:776313178928971787> 'Nulgath Demands Work', 📍`/join tercessuinotlim`)
    ...
    async def arcanas_concerto(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:swordaqw:1487004634307629056>**Arcana's Concerto**
        ...
        - 📝 Finished '[Darkon, the Conductor](https://discord.com/channels/1455651278590972019/1468338184172736739)' <:queststart:776313178928971787> at`/join ultradarkon`
        - 📝 Blacksmith Rep rank 10
        - 📝 Level 100
        ...
        - 🦴 Darkon Insignia `x5` ( <:queststart:776313178928971787> 'Darkon, the Conductor', 📍`/join ultradarkon`)
        - 🦴 King Drago Insignia `x5` ( <:queststart:776313178928971787> 'Drago, Tyrant of Astravia', 📍`/join ultradrago`)""")
    ...
    async def ravenous(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:swordaqw:1487004634307629056>**Ravenous**
        > 100% chance to activate on third skill (no cooldown⌛️).
        ...
        - 📝 Finished The Fiend Shard's Finale <:queststart:776313178928971787> from Prime Fiend Shard, buy at `/join voidchasm`
        - 📝 Level 100
    ...
    async def dauntless(self, interaction: discord.Interaction):
        await interaction.response.send_message("""<:swordaqw:1487004634307629056> **Dauntless**
        ...
        * 📝 Must have completed either the <:queststart:776313178928971787> '[Build Malgor's Armor Set](http://aqwwiki.wikidot.com/tara-s-quests#CradleFarm)' `/join manacradle`
        * 📝 or the <:queststart:776313178928971787>  '[Malgor, The First Speaker](http://aqwwiki.wikidot.com/vohu-s-quests)'  at 📍`/join ultraspeaker`
        * 📝 Must be Level 100.
        ...
        * 📝<:armoraqw:1487000736087670936> Malgor the ShadowLord ( <:queststart:776313178928971787> [Build Malgor's Armor Set](http://aqwwiki.wikidot.com/tara-s-quests#CradleFarm) ,📍 `/join manacradle`)
        * 📝<:helmaqw:1487000474014974054>  ShadowLord's Helm ( <:queststart:776313178928971787> [Build Malgor's Armor Set](http://aqwwiki.wikidot.com/tara-s-quests#CradleFarm) ,📍 `/join manacradle`)
        * 🦴 Malgor Insignia `x5` ( <:queststart:776313178928971787> 'Malgor, The First Speaker',📍`/join ultraspeaker`)
        * 🦴 Avatar Tyndarius Insignia `x10` ( <:queststart:776313178928971787> 'Ultra Avatar Tyndarius', 📍 `/join ultratyndarius`)

        <:queststart:776313178928971787> **'Build Malgor's Armor Set'**
        * 📝 💰 Gold Voucher 500k `x30`
        * 📝 <:armoraqw:1487000736087670936> Timestream Ravager
        * 📝 <:armoraqw:1487000736087670936> ShadowFlame Defender
        * 📝 <:armoraqw:1487000736087670936> Mana Guardian
        * 📝 <:armoraqw:1487000736087670936> Dark Dragon Slayer
        * 📝 <:armoraqw:1487000736087670936> Mystical Devotee of Mana
        * 📝 🦴 Dragon's Tear""")

    @forge.command(name="x", description="Look up X Forge Enhancement for X")
    async def x(self, interaction: discord.Interaction):
        await interaction.response.send_message("""""")
