...
def initialize_assets():
    ...
    ROCKS_CACHE[1] = load("basic1.png")
    ROCKS_CACHE[2] = load("basic2.png")
    ROCKS_CACHE[3] = load("basic3.png")
    ROCKS_CACHE[4] = load("basic4.png")
    ROCKS_CACHE[5] = load("basic5.png")
    ROCKS_CACHE[6] = load("basic6.png")
    ROCKS_CACHE[7] = load("pink1.png")
    ROCKS_CACHE[8] = load("pink2.png")
    ROCKS_CACHE[9] = load("gold1.png")
    ROCKS_CACHE[0] = load("dusty1.png")
