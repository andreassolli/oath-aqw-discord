...
PROXY_CHANNEL = env_int("PROXY_CHANNEL")
...
VANGUARD_NATURE = env_int("VANGUARD_NATURE_COLOR")
ROYAL_BLOOD = env_int("ROYAL_BLOOD_COLOR")
PLEDGE_PURPLE = env_int("PLEDGE_PURPLE_COLOR")
ETERNAL_OATH = env_int("ETERNAL_OATH_COLOR")
REAGENT_RICH = env_int("REAGENT_RICH_COLOR")
COLOR_ROLES = {
    VERDANT_EMBER,
    ROYAL_VANGUARD,
    MIDNIGHT_MOSS,
